...
for i in range(0, int(CLIP_FRAMES / 4) + 1):
    path = "frames/frame" + str(i * 4) + "C:\Users\user\PycharmProjects\Kresser\Просто.jpg"  # <--- path to folder containing every frame of the video
...
client.run('NzUzNjM4NjM2NjAzNTcyMjU0.X1pGrA.gbqZOL9vYWoXLSjUKa8rB8lKA2k')  # <--- Put bot token here
